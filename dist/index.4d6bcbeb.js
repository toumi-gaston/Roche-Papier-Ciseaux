...
boutonsAttack.forEach((bouton)=>{
    ...
    bouton.addEventListener("click", ()=>{
        if (bouton.ariaLabel == "Roche") playerWeaponIndex = 0;
        if (bouton.ariaLabel == "Papier") playerWeaponIndex = 1;
        if (bouton.ariaLabel == "Ciseaux") playerWeaponIndex = 2;
        ...
        let result = ()=>{
            if (playerWeaponIndex === computerWeaponIndex) {
                ...
                modal.querySelector(".modal_content_result").innerHTML = "Vous avez choisi la m\xeame arme!";
                ...
                modal.style.display = "block";
                if (playerWeaponIndex == 0) modal.querySelector(".modal_content_result").innerHTML = "Le papier enveloppe la roche";
                if (playerWeaponIndex == 1) modal.querySelector(".modal_content_result").innerHTML = "Les ciseaux coupent le papier";
                if (playerWeaponIndex == 2) modal.querySelector(".modal_content_result").innerHTML = "La roche brise les ciseaux";
                ...
                modal.style.display = "block";
                if (playerWeaponIndex == 0) modal.querySelector(".modal_content_result").innerHTML = "La roche brise les ciseaux";
                if (playerWeaponIndex == 1) modal.querySelector(".modal_content_result").innerHTML = "Le papier enveloppe la roche";
                if (playerWeaponIndex == 2) modal.querySelector(".modal_content_result").innerHTML = "Les ciseaux coupent le papier";
                console.log("player win");
                modal.querySelector(".modal_content_winner").innerHTML = "Vous avez gagn\xe9 la manche!";
                scorePlayer++;
...
},{"animate.css":"8t3va"}],"8t3va":[function() {},{}]},["e11Rl","gLLPy"], "gLLPy", "parcelRequire6ad6")
